...
app.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider.state({ name: 'page.foo.id', url: '/:id', controller: function() { }, template: '<div style="border:1px solid blue"><h3>Template 3</h3>Try to reload the page.<div style="font-size:20px">$state.params.id: {{$state.params.id}}</div>'});
});
